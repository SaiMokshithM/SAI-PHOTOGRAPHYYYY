        ...
        <div className="min-h-screen bg-white text-zinc-800">
            ...
            <main className="max-w-6xl mx-auto px-8 py-20">
                <div className="flex flex-col items-center text-center space-y-4 mb-24">
                    <h1 className="text-4xl md:text-5xl font-serif tracking-widest uppercase text-zinc-900">
                        Sai's Photography
                    </h1>
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-2 md:order-1 space-y-8 text-center md:text-left">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <h2 className="text-3xl font-serif text-zinc-800 mb-8 tracking-wide">
                                Hello, I'm Sai.
                            </h2>
                            <div className="space-y-6 font-serif text-zinc-600 leading-loose text-lg">
                                <p>
                    ...
                    <div className="order-1 md:order-2 flex justify-center md:justify-end">
                        <motion.div
                            ...
                            className="bg-white p-4 shadow-[0_0_30px_rgba(0,0,0,0.05)]"
                        >
                            <img
